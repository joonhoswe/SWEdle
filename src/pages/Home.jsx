    ...
    return (
        <div className="bg-gray-900 flex flex-col justify-center items-center h-screen">
            ...
            <div className="flex justify-center items-center space-x-6 mt-8">
                ...
                <button className="hover:scale-110 w-32 flex-shrink-0 bg-blue-500 text-white py-2 px-4 rounded transition duration-300 ease-in-out hover:bg-blue-600 focus:outline-none" onClick={goToGame}> Log In </button>
            </div>
